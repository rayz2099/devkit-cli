...
complete -c codeup-cli -l message -r -d 'merge commit message'
complete -c codeup-cli -l type -x -a 'squash ff-only no-fast-forward rebase' -d 'merge type, default squash'
